...
const App = () => {
    ...
    const handleLogin = async (email, password) => {
        try {
            const response = await fetch('https://godown-treeview.onrender.com/api/auth/login', {
                method: 'POST',
                headers: {
    ...
    const handleRegister = async (name, email, password) => {
        try {
            const response = await fetch('https://godown-treeview.onrender.com/api/auth/register', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
